...
namespace WinFormsApp1
{
    public partial class UsersProfileAdminForm : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                using (MySqlConnection connection = db.getConnection())
                {
                    ...
                    string selectQuery = "SELECT FIO, Passport, Address, Phone, Email FROM Clients WHERE FIO = @selectedFIO";
        ...
        private string GetLoginFromDB(string selectedFIO)
        {
            ...
            {
                db.openConnection();
                MySqlCommand command = new MySqlCommand("SELECT Email FROM Clients WHERE FIO = @selectedFIO", connection);
        ...
        // Ваш обработчик события загрузки формы UsersProfileAdminForm_Load с использованием новой функции
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                MySqlCommand command = new MySqlCommand("DELETE FROM Clients WHERE Email = @Login;", connection);
